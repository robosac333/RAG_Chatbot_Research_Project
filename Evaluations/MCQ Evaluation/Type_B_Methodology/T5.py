...
def evaluate_model(questions):
    ...
    with open(r'responses_and_probabilities_RAG_T5_Confidence.txt', 'w', encoding='utf-8') as file:
        file.write('\n'.join(responses_and_truths))
    
    # Save the average time per question metric.
    with open(r'performance_metrics_RAG_T5.txt', 'w', encoding='utf-8') as file:
