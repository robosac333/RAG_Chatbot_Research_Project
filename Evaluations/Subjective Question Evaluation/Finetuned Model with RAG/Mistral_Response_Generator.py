...
Db_faiss_path = r"C:\Users\Computing\Downloads\OneDrive_2024-07-29\Two Models\Flan-T5-Model\Flan-T5-Model\Vector_Data_Base_GTR_T5_Large"
...
def load_questions_answers(file_path, limit=10):
    questions = []
...
def evaluate_model(questions, generate_answer, few_shot_examples):
    ...
    with open(r'C:\Users\Computing\Downloads\OneDrive_2024-07-29\Two Models\Mistral Ai LLm\Mistral Ai LLm\Medical Question\responses_and_truths.txt', 'w', encoding='utf-8') as file:
        file.write('\n'.join(responses_and_truths))
    
    # Save average time to a text file
    with open(r'C:\Users\Computing\Downloads\OneDrive_2024-07-29\Two Models\Mistral Ai LLm\Mistral Ai LLm\Medical Question\performance_metrics.txt', 'w', encoding='utf-8') as file:
...
def main():
    questions_file_path = r'C:\Users\Computing\Downloads\OneDrive_2024-07-29\Two Models\Mistral Ai LLm\Mistral Ai LLm\Medical Question\Medical_Data.csv'
    questions = load_questions_answers(questions_file_path, limit=10)
