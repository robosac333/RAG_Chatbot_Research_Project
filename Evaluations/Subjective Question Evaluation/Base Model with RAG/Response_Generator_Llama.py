...
def evaluate_model(questions, generate_answer, few_shot_examples):
    ...
    with open(r'C:\Users\Computing\Downloads\Base_Model_With_RAG_Medical\Responses_Time\responses_and_truths_Llama_Base2.txt', 'w', encoding='utf-8') as file:
        file.write('\n'.join(responses_and_truths))
    
    # Save average time to a text file
    with open(r'C:\Users\Computing\Downloads\Base_Model_With_RAG_Medical\Responses_Time\performance_metrics_Llama_Base2.txt', 'w', encoding='utf-8') as file:
